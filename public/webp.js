...
function renderSelection(fileListLike) {
  ...
  if (!files.length) {
    fileList.hidden = true; fileListItems.innerHTML = ""; fileListSummary.textContent = ""; return;
  }
...
form.addEventListener("submit", e => {
  ...
  xhr.onreadystatechange = () => { if (xhr.readyState === XMLHttpRequest.HEADERS_RECEIVED) setIndeterminate("Procesando imágenes…"); };
...
function setDisabled(d){ form.querySelector("button[type=submit]").disabled=d; fileInput.disabled=d; }
